...
# 3rd Party Signing Script to sign downloadable 3rd party  
# module 
# Signed 3rd party package shall be used as reference

# Arguement Required
# 1. Signing Key: Use to sign the package
# 2. CA Certificate: To be bundled together with tarball
# 3. Packaged File: Which needs to be signed, multiple packages
#                   for signing can be provided at a time
# 4. App Manager Conf: Config file required having app meta data
#                      to make entry into app manager config file
